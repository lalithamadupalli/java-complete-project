...
stages {
    ...
    stage('Jmeter test') {
         steps {
              sh "/opt/jmeter/bin/jmeter Jjmeter.save.saveservice.output_format=xml -Jjmeter.save.saveservice.output_format=csv -n -t src/main/jmeter/Testing.jmx -l test.jtl -e -o output "
